...
compatmsg	db "POWER compatibility option - use APM HELP",13,10
		db "to learn about new APM syntax.",13,10,"$"
...
helpmsg	db "Usage: Give APM any one option from the following list.",13,10
